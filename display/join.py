...
def main(screen, clock, screenSize):
    ...
    #test
    buttonsTab = []
    button1 = utils.button.Button('appuis sur espace',(200, 100), 300, height=40, elevation=7, idColor=2, fontSize=15, border_radius=12, pawDisplaying=False, colorText='#F3A8AF')
